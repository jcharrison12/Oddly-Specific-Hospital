...
EXTERNAL UpdateScore(points, direction)
...
{PlaySound("SFX gasp 2")}
{ChangeMood("Carmella", "Worried")}
{ChangeMood("Doctor", "Worried")}
...
=== husband ===
{ShowCharacter("David", "Left", "Angry")}
{ChangeMood("Doctor", "Neutral")}
{ChangeMood("Carmella", "Neutral")}
...
{ShowCharacter("Priscilla", "Center", "Neutral")}
...
{UpdateScore(audience, "up")}
{PlaySound("SFX soliloquy")}
{ChangeMood("David", "Dramatic")}
...
{UpdateScore(audience, "up")}
{PlaySound("SFX dog barks")}
{PlaySound("SFX laugh 2")}
{ChangeMood("David", "Worried")}
{ChangeMood("Doctor", "Happy")}
...
=== contractions ===
{PlaySound("SFX IV drip")}
{ChangeMood("David", "Neutral")}
{ChangeMood("Doctor", "Neutral")}
{ShowCharacter("Carmella", "Center", "Neutral")}
...
{HideCharacter("Carmella")}
{ShowCharacter("Priscilla", "Center", "Neutral")}
You sneak a quick look at the director, who looks {checkpoint1: pleased as punch at your performance. You are emboldened to make bigger and better acting choices.{ShowCharacter("Director", "Left", "Happy")}} {not checkpoint1: really pissed at your performance. He draws his finger across his throat threateningly. You suddenly feel a lot more nervous than you were before.{ShowCharacter("Director", "Left", "Threatening")}}
...
{UpdateScore(audience, "up")}
{HideCharacter("Priscilla")}
{ShowCharacter("David", "Center", "Worried")}
{HideCharacter("Director")}
{ShowCharacter("Carmella", "Left", "Worried")}
{ChangeMood("Doctor", "Worried")}
{PlaySound("SFX gasp 1")}
{PlaySound("SFX morse code")}
...
{PlaySound("SFX gasp 1")}
{HideCharacter("Priscilla")}
{ShowCharacter("Carmella", "Center", "Angry")}
...
{HideCharacter("Doctor")}
{ShowCharacter("David", "Center", "Worried")}
{ShowCharacter("Priscilla", "Right", "Cop")}
...
=== facetime ===
{PlaySound("SFX baby crying")}
{ShowCharacter("Baby", "Left", "Neutral")}
{ShowCharacter("Carmella", "Center", "Dramatic")}
{ShowCharacter("Doctor", "Right", "Neutral")}
{HideCharacter("David")}
{HideCharacter("Priscilla")}
...
{HideCharacter("Priscilla")}
{HideCharacter("David")}
{ShowCharacter("Doctor", "Left", "Dramatic")}
{ShowCharacter("Carmella", "Center", "Dramatic")}
...
===newborn_insem===
{PlaySound("SFX baby crying")}
{ShowCharacter("Baby", "Right", "Neutral")}
"Wah wah!" cries the newly born infant. #baby
* "I love to see a happy family," you end. 
{audience > 25: -> good_end}
{audience <= 25: -> bad_end}
...
{HideCharacter("Baby")}
{HideCharacter("Doctor")}
{ShowCharacter("Director", "Left", "Happy")}
{ShowCharacter("Doctor", "Right", "Happy")}
...
{HideCharacter("Baby")}
{HideCharacter("Doctor")}
{ShowCharacter("Director", "Left", "Angry")}
{ShowCharacter("Doctor", "Right", "Worried")}
...
{UpdateScore(audience, "up")}
{PlaySound("SFX toy impaled")}
{PlaySound("SFX wood")}
{HideCharacter("David")}
{HideCharacter("Carmella")}
{ShowCharacter("Priscilla", "Center", "Cop")}
{ShowCharacter("Baby", "Left", "Vampire")} 
...
{HideCharacter("Baby")}
{ShowCharacter("Carmella", "Left", "Worried")}
{ShowCharacter("David", "Right", "Angry")}
